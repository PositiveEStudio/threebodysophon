...
public class TileEntityRegistryHandler
{
    ...
    public static final RegistryObject<TileEntityType<TileEntityLowDimensionalExpansionInstrument>> TILE_ENTITY_LOW_DIMENSIONAL_EXPANSION_INSTRUMENT = TILE_ENTITY_REGISTER.register("tile_entity_low_dimensional_expansion_instrument", () -> TileEntityType.Builder.create(TileEntityLowDimensionalExpansionInstrument::new, BlockRegistryHandler.LOW_DIMENSIONAL_EXPANSION_INSTRUMENT).build(null));
}
