...
public class EntitySophon extends Entity implements IEntityAdditionalSpawnData
{
    ...
    private UUID trackingPlayer; // 移动到玩家面前时，该玩家的UUID
    ...
    protected void readAdditional(CompoundNBT compound)
    {
        ...
        if (compound.contains("TrackingPlayer")) {
            this.trackingPlayer = compound.getUniqueId("TrackingPlayer");
        }
    }
    ...
    protected void writeAdditional(CompoundNBT compound)
    {
        ...
        compound.putUniqueId("TrackingPlayer", this.trackingPlayer);
    }
